...
dofile(GetResPath("script/market/market_global.lua"))
dofile(GetResPath("script/market/IGS_server.lua"))
...
function MsgProc(character, npc, rpk, page, trade, missionlist, exchangeData)
    ...
    elseif usCmd == CMD_CM_FUNCITEM then
        ...
        elseif item.func == ChangeItem then
            return ChangeItem(character, npc)
		elseif item.func == OpenMarketGlobalFromNPC then
			return OpenMarketGlobalFromNPC(character, npc)			
        else
