...
#include "NetProtocol.h" // Para LPRPACKET
#include "NetIF.h"
#include <time.h>
#include "c:/sources/Libraries/Discord/Include/discord_rpc.h"

// Removido SC_MarketList duplicado/conflitante
extern void CS_MarketList();
...
// Comandos de mercado global
extern void CS_MarketList();
extern void CS_MarketAddItem(int item_id, int quantidade, int preco);
extern void CS_MarketBuy(int market_id);
extern void CS_MarketFetchMoney();

// Handlers de resposta do mercado global
extern BOOL SC_MarketBuyResult(LPRPACKET pk);
extern BOOL SC_MarketAddItemResult(LPRPACKET pk);
extern BOOL SC_MarketFetchMoneyResult(LPRPACKET pk);
